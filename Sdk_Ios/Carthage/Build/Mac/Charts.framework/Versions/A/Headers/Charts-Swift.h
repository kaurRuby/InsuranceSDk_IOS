...
- (void)setValueTextColor:(NSColor * _Nonnull)color;
/// Sets the font for all value-labels for all DataSets this data object contains.
- (void)setValueFont:(NSFont * _Nonnull)font;
...
///
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon;
/// \param y the y value (the actual value of the entry)
///
/// \param icon icon image
///
/// \param data Space for additional data this Entry represents.
///
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
...
/// \param icon icon image
///
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon;
/// An Entry represents one single entry in the chart.
/// \param x the x value
///
/// \param y the y value (the actual value of the entry)
...
/// \param data Space for additional data this Entry represents.
///
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
- (nonnull instancetype)initWithX:(double)x yValues:(NSArray<NSNumber *> * _Nonnull)yValues icon:(NSImage * _Nullable)icon;
/// Constructor for stacked bar entries. One data object for whole stack
- (nonnull instancetype)initWithX:(double)x yValues:(NSArray<NSNumber *> * _Nonnull)yValues data:(id _Nullable)data;
/// Constructor for stacked bar entries. One data object for whole stack
- (nonnull instancetype)initWithX:(double)x yValues:(NSArray<NSNumber *> * _Nonnull)yValues icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
...
@property (nonatomic, strong) NSFont * _Nonnull noDataFont;
...
/// \param icon icon image
///
- (nonnull instancetype)initWithX:(double)x y:(double)y size:(CGFloat)size icon:(NSImage * _Nullable)icon;
/// \param x The index on the x-axis.
///
/// \param y The value on the y-axis.
///
...
/// \param data Spot for additional data this Entry represents.
///
- (nonnull instancetype)initWithX:(double)x y:(double)y size:(CGFloat)size icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon;
...
- (nonnull instancetype)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
...
/// \param data Spot for additional data this Entry represents
///
- (nonnull instancetype)initWithValue:(double)value label:(NSString * _Nullable)label icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
/// \param value The value on the y-axis
///
/// \param data Spot for additional data this Entry represents
///
